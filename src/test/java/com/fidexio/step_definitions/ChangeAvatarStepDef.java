...
public class ChangeAvatarStepDef {
    ...
    public void the_user_able_to_click_edit_sign() throws InterruptedException, AWTException {
        ...
        String projectPath= "/Users/karanfilyigit/Desktop/avatar-2-3-filmloverss.jpeg"; ///Users/karanfilyigit/Desktop/avatar-2-3-filmloverss.jpeg
         new DashboardPage().EditButton.sendKeys(projectPath);
    ...
    @Then("the user able to click Save button")
    public void the_user_able_to_click_Save_button() {
        new DashboardPage().saveButton.click();
